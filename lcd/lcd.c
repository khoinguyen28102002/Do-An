...
//ham hien thi phim chon chuc nang
void Init_flag() {
    LcdPrintStringS(0,0,"A:SET");
    LcdPrintStringS(0,9,"B:MAN");
    LcdPrintStringS(1,0,"C:SLOW"); 
    LcdPrintStringS(1,9,"#:START");
}
void Init_enter_password(){
